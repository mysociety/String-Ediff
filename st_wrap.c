...
#define SWIG_name   "String::Ediffc::boot_String__Ediff"
#define SWIG_prefix "String::Ediffc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_String__Ediff_var::
class _wrap_String__Ediff_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_ediff) {
  {
    ...
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ediff" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    res2 = SWIG_AsCharPtrAndSize(ST(1), &buf2, NULL, &alloc2);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ediff" "', argument " "2"" of type '" "char *""'");
    }
    arg2 = (char *)(buf2);
...
{"String::Ediffc::ediff", _wrap_ediff},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
